...
testParameters = [ # Test single device alone timing, all channels , ADR
                  ...
                  { "testRun" : "C2",
                    ...
                    "TestParam" : [{ "mode" : 2, "chnMsk" : 0x07, "dataRate" : 0, "repeat" : 0 },
                                   { "mode" : 2, "chnMsk" : 0x07, "dataRate" : 0, "repeat" : 0 },
                                   { "mode" : 2, "chnMsk" : 0x07, "dataRate" : 0, "repeat" : 0 }]},
                  
                   # Test run frequency exhaustion with ADR
                  { "testRun" : "C3",
                    "NodeParam" : [{"mode" : 2, "conf" : 1}],
                    "TestParam" : [{"mode" : 2, "dataLen": 242, "usePB" : 0, "repeat" : 0 },
                                   {"mode" : 2, "dataLen": 242, "usePB" : 0, "repeat" : 0 },
                                   {"mode" : 2, "dataLen": 242, "usePB" : 0, "repeat" : 0 },
                                   {"mode" : 2, "dataLen": 242, "usePB" : 0, "repeat" : 0 },
                                   {"mode" : 2, "dataLen": 242, "usePB" : 0, "repeat" : 0 },
                                   {"mode" : 2, "dataLen": 242, "usePB" : 0, "repeat" : 0 },
