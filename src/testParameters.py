...
testParameters = [
                  ...
                  { "testRun" : "C2",
                    ...
                    "TestParam" : [{ "mode" : 2, "chnMsk" : 0x07, "dataRate" : 0, "usePB" : 1, "repeat" : 0 },
                                   { "mode" : 2, "chnMsk" : 0x07, "dataRate" : 0, "usePB" : 1, "repeat" : 0 },
                                   { "mode" : 2, "chnMsk" : 0x07, "dataRate" : 0, "usePB" : 1, "repeat" : 0 }]},
                  
                   # Test run frequency exhaustion with ADR
                  { "testRun" : "C3",
                    "NodeParam" : [{"mode" : 2, "conf" : 1}],
                    "TestParam" : [{"mode" : 2, "dataLen": 242, "usePB" : 1, "repeat" : 0 },
                                   {"mode" : 2, "dataLen": 242, "usePB" : 1, "repeat" : 0 },
                                   {"mode" : 2, "dataLen": 242, "usePB" : 1, "repeat" : 0 },
                                   {"mode" : 2, "dataLen": 242, "usePB" : 1, "repeat" : 0 },
                                   {"mode" : 2, "dataLen": 242, "usePB" : 1, "repeat" : 0 },
                                   {"mode" : 2, "dataLen": 242, "usePB" : 1, "repeat" : 0 },
                  ...
                  { "testRun" : "C4",
                    ...
                    "TestParam" : [{"mode" : 1, "freq" : 8683, "dataLen": 0, "spreadFactor": 7, "codeRate": 5, "repeat" : 0 },
                                   {"mode" : 1, "freq" : 8681, "dataLen": 0, "spreadFactor": 7, "codeRate": 5, "repeat" : 0 },
                                   {"mode" : 1, "freq" : 8685, "dataLen": 0, "spreadFactor": 7, "codeRate": 5, "repeat" : 0 },
                                   {"mode" : 1, "freq" : 8671, "dataLen": 0, "spreadFactor": 7, "codeRate": 5, "repeat" : 0 },
                                   {"mode" : 1, "freq" : 8673, "dataLen": 0, "spreadFactor": 7, "codeRate": 5, "repeat" : 0 },
                                   {"mode" : 1, "freq" : 8675, "dataLen": 0, "spreadFactor": 7, "codeRate": 5, "repeat" : 0 },
                                   {"mode" : 1, "freq" : 8677, "dataLen": 0, "spreadFactor": 7, "codeRate": 5, "repeat" : 0 },
                                   {"mode" : 1, "freq" : 8679, "dataLen": 0, "spreadFactor": 7, "codeRate": 5, "repeat" : 0 },]},
